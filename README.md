...
- 🔄 **一键切换**模型，即时生效
- 🔥 **热切换**：Claude Code 运行中也能切，不丢上下文
- 📋 **会话级切换**：每个终端可用不同模型
- 📦 **管理模型配置**（增删改查 + 导入已有配置）
- 🖥️ **跨终端通用**（iTerm2 / Terminal / IDEA / Cursor / VS Code / Warp...）
- ⚡ **Hook 自动安装/升级**：App 启动自动安装，版本更新时一键升级
...
| 文件 | 适用机型 |
|------|---------|
| `CC Switch Plus-1.2.0-arm64.dmg` | Apple Silicon (M1/M2/M3/M4) |
| `CC Switch Plus-1.2.0.dmg` | Intel Mac |
...
App 启动时会自动安装 Hook。也可在 **设置** 标签页手动安装/升级。
